(* OASIS_START *)
(* DO NOT EDIT (digest: 9f5d7ffb52ba81c0e54da1b1726ca564) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/js-build-tools";
          synopsis =
          ...
          description =
            Some
              [
                 OASISText.Para
                   "This packages contains tools to help building Jane Street Packages. However most of it is general purpose. It contains:: - an oasis2opam-install tool to produce a .install file from the oasis build log - an js_build_tools ocamlbuild plugin with various goodies"
              ];
          categories = [];
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "jane_street_ocamlbuild_goodies";
                   ...
                   {
                      lib_modules = ["Jane_street_ocamlbuild_goodies"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Oasis2opam_install"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "=C\168|\019\147'\003d\018\202V\142=\019m";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
